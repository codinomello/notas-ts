...
function mostrar() {
  ...
  if (nível === "EFI") {
    ...
    document.getElementById('prova-objetiva').classList.add('hidden')
    document.getElementById('PO3').classList.add('hidden')
  } 
  else if (nível === "EFII") {
    document.getElementById('formulário').classList.remove('hidden')
    document.getElementById('regular-seção').classList.add('hidden')
    ...
    document.getElementById('PO3-label').classList.add('hidden')
    document.getElementById('PO3').classList.add('hidden')
  } 
  else if (nível === "EM") {
    document.getElementById('formulário').classList.remove('hidden')
    ...
    const PO3 = document.getElementById('PO3-label')
    PO3.classList.remove('hidden')
    document.getElementById('PO3').classList.remove('hidden')
  }
}
